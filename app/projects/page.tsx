...
const ProjectsPage: React.FC = () => {
  ...
  const filteredProjects: ProjectItemProps[] =
    selectedCategory === "All"
      ? projectsData
      : projectsData.filter((project: ProjectItemProps) =>
    ...
    <div className="container mx-auto py-8 px-4 md:px-12">
      ...
      <div className="mb-8 flex flex-wrap justify-center">
        {categories.map((category) => (
          <button
            key={category}
            className={`mr-4 mb-2 px-4 py-2 rounded-md font-semibold transition-colors ${
