    ...
    <div className="container mx-auto py-8 px-4 md:px-12">
      ...
      <div className="flex flex-col xl:flex-row justify-center items-center">
        ...
        <div className="rounded-lg overflow-hidden flex-1 justify-center">
          <button
            className="h-full min-w-full max-h-screen flex items-center justify-center rounded-md focus:outline-none"
        ...
        <div className="w-full xl:w-2/6 m-1 mx-3 flex flex-col justify-center">
          ...
          <div className="mb-6">
            {project.category.map((cat, index) => (
              <span
                key={index}
                className="inline-block bg-blue-600 text-white px-3 py-1 rounded-full text-sm font-semibold mr-2"
              >
                {cat.toUpperCase()}
              </span>
            ))}
